...
from obsidian_knowledge_shared.knowledge_lint import build_lint_report, write_lint_report
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the Vaultwright knowledge lint workflow against an Obsidian vault.")
