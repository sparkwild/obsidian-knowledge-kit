---
description: Verify obs-wiki installation state and optionally install the minimal global AGENTS knowledge-base hint.
---

# obs-wiki Setup

Prepare Codex so new sessions can reliably discover and use the active Obsidian vault through obs-wiki.
...
```bash
python3 ~/.codex/plugins/obs-wiki/scripts/install_global_knowledge_hint.py --apply --json
```
