...
from obs_wiki_shared.source_register_state import apply_reconciled_register, reconcile_source_register
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Reconcile an obs-wiki raw/source register with actual claim/evidence and synthesis-target state.")
