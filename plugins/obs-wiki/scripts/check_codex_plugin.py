...
EXPECTED_SKILL_SCRIPT_PATHS = (
    "obs-wiki-init/scripts/check_kepano_skills.py",
    "obs-wiki-init/scripts/check_obsidian_env.py",
    "obs-wiki-init/scripts/install_or_update_kepano_skills.py",
    "obs-wiki-init/scripts/render_core_notes.py",
    "obs-wiki-ingest/scripts/check_kepano_skills.py",
    "obs-wiki-ingest/scripts/check_obsidian_env.py",
    "obs-wiki-ingest/scripts/install_or_update_kepano_skills.py",
    "obs-wiki-refine/scripts/check_kepano_skills.py",
    "obs-wiki-refine/scripts/check_obsidian_env.py",
    "obs-wiki-refine/scripts/install_or_update_kepano_skills.py",
)
...
def command_referenced_scripts(commands_path: Path) -> set[str]:
    pattern = re.compile(
        r"(?:^|[\s`])(?:~\/(?:\.codex\/)?plugins\/obs-wiki\/)?scripts\/([A-Za-z0-9_]+\.py)"
    )
...
def build_report(require_installed: bool) -> dict:
    ...
    lib_path = plugin_root / "lib" / "obs_wiki_shared"
