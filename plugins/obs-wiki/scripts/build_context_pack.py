...
from obs_wiki_shared.context_pack import build_context_pack, write_context_pack
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build an obs-wiki context pack note for an Obsidian knowledge-base query.")
