---
name: obsidian-knowledge-query
description: Query an active Obsidian knowledge vault through a Vaultwright context pack. Use when the user asks a knowledge-base-related question, wants targeted retrieval instead of full-vault reading, or needs Codex to identify candidate notes, source candidates, knowledge gaps, and likely writeback targets before answering. Always treat the active Obsidian vault as the only knowledge carrier and avoid creating external raw/wiki directory systems.
---
