---
description: Build a Vaultwright context pack for a knowledge question before reading candidate notes or answering.
---
...
```bash
python3 ~/.codex/plugins/obsidian-knowledge-kit/scripts/build_context_pack.py "<question>" --json
```

If you are ready to write the context pack note into the vault:

```bash
python3 ~/.codex/plugins/obsidian-knowledge-kit/scripts/build_context_pack.py "<question>" --apply --json
```
