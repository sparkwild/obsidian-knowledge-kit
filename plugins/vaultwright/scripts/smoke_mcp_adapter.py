    ...
    messages = [
        request(
            ...
            "initialize",
            {
                ...
                "capabilities": {},
                "clientInfo": {"name": "vaultwright-smoke", "version": "0.1.0"},
            },
        ),
        {"jsonrpc": "2.0", "method": "notifications/initialized"},
        request(2, "tools/list"),
        request(3, "tools/call", {"name": "vaultwright_status", "arguments": {}}),
        request(4, "tools/call", {"name": "vaultwright_query", "arguments": {"query": "benchmark evidence"}}),
        request(5, "tools/call", {"name": "vaultwright_lint", "arguments": {"issue_limit": 10}}),
        request(6, "tools/call", {"name": "vaultwright_read_note", "arguments": {"path": "00_system/system.md"}}),
        request(7, "tools/call", {"name": "vaultwright_review_queue", "arguments": {"limit": 5}}),
        request(8, "resources/list"),
        request(9, "resources/read", {"uri": "vaultwright://system"}),
        request(10, "prompts/list"),
        request(11, "tools/call", {"name": "vaultwright_read_note", "arguments": {"path": "../outside.md"}}),
    ]
