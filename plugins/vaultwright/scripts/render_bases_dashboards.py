...
from obsidian_knowledge_shared.obsidian_runtime import write_note_content
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Render or install Vaultwright Obsidian Bases dashboards into a vault.")
