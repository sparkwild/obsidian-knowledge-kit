...
EXPECTED_SKILL_SCRIPT_PATHS = (
    "vaultwright-init/scripts/check_kepano_skills.py",
    "vaultwright-init/scripts/check_obsidian_env.py",
    "vaultwright-init/scripts/install_or_update_kepano_skills.py",
    "vaultwright-init/scripts/render_core_notes.py",
    "vaultwright-ingest/scripts/check_kepano_skills.py",
    "vaultwright-ingest/scripts/check_obsidian_env.py",
    "vaultwright-ingest/scripts/install_or_update_kepano_skills.py",
    "vaultwright-refine/scripts/check_kepano_skills.py",
    "vaultwright-refine/scripts/check_obsidian_env.py",
    "vaultwright-refine/scripts/install_or_update_kepano_skills.py",
)
...
def command_referenced_scripts(commands_path: Path) -> set[str]:
    pattern = re.compile(
        r"(?:^|[\s`])(?:~\/(?:\.codex\/)?plugins\/vaultwright\/)?scripts\/([A-Za-z0-9_]+\.py)"
    )
