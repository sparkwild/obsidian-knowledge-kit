...
```bash
python3 ~/.codex/plugins/vaultwright/scripts/render_session_skeleton.py --apply --json
```
...
```bash
python3 ~/.codex/plugins/vaultwright/scripts/apply_distill_updates.py "02_timeline/sessions/<session>.md" \
