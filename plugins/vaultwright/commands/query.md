...
```bash
python3 ~/.codex/plugins/vaultwright/scripts/build_context_pack.py "<question>" --json
```

If you are ready to write the context pack note into the vault:

```bash
python3 ~/.codex/plugins/vaultwright/scripts/build_context_pack.py "<question>" --apply --json
```
