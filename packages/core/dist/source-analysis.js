...
exports.analyzeSourceText = analyzeSourceText;
...
function buildSummary(source, analysisMode, purpose, text) {
...
function buildProposalDrafts(source, sourceKind, analysisMode, summary, evidences, claims, requestPath) {
    const drafts = [];
...
function analyzeSourceText(input) {
