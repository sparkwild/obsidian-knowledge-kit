...
**obs-wiki：让 Agent 使用 Obsidian vault 作为外置长期记忆库和知识库。**
...
7. **Plugin-first for user supervision**：Obsidian 插件是用户监督与复核界面。
8. **Runtime as engine**：Memory Runtime 负责检索、索引、context pack、lint、source analysis。
