...
- The Obsidian plugin does not read or write files outside the active vault except for user-confirmed client configuration changes.

## User Responsibility

Users remain responsible for reviewing proposed memory changes, backing up important vaults, and controlling which AI tools are connected.
