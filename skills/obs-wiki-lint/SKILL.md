---
name: obs-wiki-lint
description: Run a read-only health check over an obs-wiki-managed Obsidian knowledge vault. Use when the user wants to inspect knowledge accuracy, structure health, evidence coverage, broken links, stale concepts, orphan notes, or missing log trails. This workflow complements doctor: doctor checks environment and installation, while lint checks vault content quality.
---
