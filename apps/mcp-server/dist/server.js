            ...
            case 'initialize':
                return {
                    ...
                    serverInfo: {
                        ...
                        title: 'obs-wiki MCP Server (Read-only MVP)',
                        version: '0.1.0',
                    },
                    instructions: 'This MCP server is read-only and scoped to vault-local read operations only. It refuses vault-outside reads and .obsidian paths.',
                };
            case 'tools/list':
