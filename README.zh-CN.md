...
Vaultwright 将 AI 对话入口和本地确定性执行层分开：
...
- [English README](./README.md)
- [Codex 任务方案](./docs/Vaultwright_Codex_Task_Brief.md)
- [Phase 2 MCP/CLI 性能方案](./docs/Vaultwright_Phase2_MCP_CLI_Performance_Plan.md)
- [MCP Adapter 设计](./docs/Vaultwright_MCP_Adapter_Design.md)
- [Runtime 性能评估](./docs/Vaultwright_Runtime_Performance_Evaluation.md)
- [Phase 2 执行清单](./docs/Vaultwright_Phase2_Execution_Checklist.md)
